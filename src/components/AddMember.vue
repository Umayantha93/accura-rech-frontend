        ...
        <div class="alert alert-danger mt-4" v-if="errors.length">
            ...
            <form class="row g-3">
                ...
                <div class="col">
                    ...
                    <button type="button" @click.prevent="saveMember" class="btn btn-outline-success">Save Member</button>
            ...
            methods: {
                saveMember() {
                    ...
                    if(!this.errors.length) {
                        ...
                        formData.append('division', this.member.division);
                        formData.append('date_of_birth', this.member.date_of_birth);
                        formData.append('summery', this.member.summery);
                        axios.post('http://127.0.0.1:8000/api/add-member', formData).then(() => {
                            this.$router.push({
                                name: 'Home'
                            })
                        }).catch(error => {
